# Contributing to hubAdmin

This outlines how to propose a change to `hubAdmin`. For more general
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("hubverse-org/hubAdmin", fork = TRUE)`.
...
Please note that the hubAdmin project is released with a [Contributor
Code of
Conduct](https://hubverse-org.github.io/hubAdmin/dev/CODE_OF_CONDUCT.md).
